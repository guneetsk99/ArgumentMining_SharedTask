...
class BaselineLSTMModel(nn.Module):
    ...
    def __init__(self, args, bertModel):
        ...
        classifier = [nn.Linear(args.hidden_dim * 2, 150), nn.ReLU(), nn.Linear(150, 100),nn.ReLU(), nn.Linear(100, 50), nn.ReLU(), nn.Linear(50, args.class_num)]
    ...
    def forward(self, embedder_input, input_mask, seq_lens, bio_tags, type_idx):
        ...
        lstm_embedding,x=self.attention(lstm_embedding,lstm_embedding)
        lstm_embedding,x=self.attention(lstm_embedding,lstm_embedding)
